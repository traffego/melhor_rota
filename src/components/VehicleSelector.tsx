    ...
    <div className="w-full space-y-1.5" ref={containerRef}>
      ...
      <div className="relative">
        <button
          ...
          className="w-full text-left px-3 py-2 bg-white hover:bg-slate-50 border border-slate-200 rounded-xl text-xs font-medium text-slate-900 focus:outline-none focus:ring-1 focus:ring-slate-400 transition-all flex items-center justify-between shadow-sm"
        >
            ...
            <div className="truncate">
              {selectedVehicle ? (
                <div>
                  ...
                  <p className="text-[10px] text-slate-500">{selectedVehicle.fuel_type || "Flex"}</p>
                </div>
              ) : (
                <p className="text-slate-400 font-normal">Buscar carro (ex: Onix, Civic, Prisma, Gol)...</p>
              )}
            </div>
          </div>
